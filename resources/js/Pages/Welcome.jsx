                            ...
                            <div className="grid gap-6 lg:grid-cols-5 lg:gap-8">
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Thư viện là một kho sưu tập các
                                            nguồn thông tin, được chọn lựa bởi
                                            các chuyên gia và có thể được tiếp
                                            cận để tham khảo hay mượn, thường là
                                            trong một môi trường yên tĩnh phù
                                            hợp cho học tập.
                                        </p>
                                    </div>
                                </a>
